...
Поиск по заданию начинается с подготовки документов в методе [InvertedIndex](#class_InvertedIndex)::PrepareDocs(this). Из подготовленных документов (vector docs) формируется 
