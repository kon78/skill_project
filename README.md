...
## About...
Программа SkillBoxSearchEngine представляет из себя консольное приложение, (исполняемый файл запускаемый на компьютере),
осуществляющее поиск и имеющее возможность настройки через файлы формата JSON и текстовый файлы TXT. Приложение написно на C++
...
Пользователь задаёт запрос через файл requests.txt, который JSON-файл [REQUESTS.JSON](#Requestsjson). Запрос — это набор слов, по которым нужно найти документы.  
